...
{
  int32_T i;
  uint8_T rtb_TmpSignalConversionAtSerial[51];
  uint8_T status;
  ...
  /* Pack: <S8>/Byte Pack7 */
  (void) memcpy(&Final_Simulink_Model_assignme_B.BytePack7[0],
                &Final_Simulink_Model_assignme_B.Reaction_time,
                2);
  ...
  /* Pack: <S8>/Byte Pack8 */
  (void) memcpy(&Final_Simulink_Model_assignme_B.BytePack8[0],
                &Final_Simulink_Model_assignme_B.Recovery_time,
                2);
  ...
  rtb_TmpSignalConversionAtSerial[47] =
    Final_Simulink_Model_assignme_B.BytePack7[0];
  rtb_TmpSignalConversionAtSerial[49] =
    Final_Simulink_Model_assignme_B.BytePack8[0];
  rtb_TmpSignalConversionAtSerial[48] =
    Final_Simulink_Model_assignme_B.BytePack7[1];
  rtb_TmpSignalConversionAtSerial[50] =
    Final_Simulink_Model_assignme_B.BytePack8[1];
  ...
  while (status != 0) {
    memcpy((void *)&Final_Simulink_Model_assignme_B.TxDataLocChar[0], (void *)
           &rtb_TmpSignalConversionAtSerial[0], (size_t)51 * sizeof(uint8_T));
    status = MW_SCI_Transmit(Final_Simulink_Model_assignm_DW.obj_es.MW_SCIHANDLE,
      &Final_Simulink_Model_assignme_B.TxDataLocChar[0], 51U);
  }
