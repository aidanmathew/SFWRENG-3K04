 ...
 * C/C++ source code generated on : Sun Nov 27 00:21:33 2022
 *
  ...
  PACE_CHARGE_CTRL, const boolean_T *ATR_CMP_DETECT)
{
  ...
  *PACE_GND_CTRL = true;
  if (!*ATR_CMP_DETECT) {
    Final_Simulink_Model_assignme_B.d3 = rt_roundd_snf(60000.0 / (real_T)
      Final_Simulink_Model_assignme_B.LRL);
    if (Final_Simulink_Model_assignme_B.d3 < 256.0) {
      Final_Simulink_Model_assignme_B.u3 = (uint8_T)
        Final_Simulink_Model_assignme_B.d3;
    } else {
      Final_Simulink_Model_assignme_B.u3 = MAX_uint8_T;
    }

    Final_Simulink_Model_assignme_B.qY_p = (uint32_T)
      Final_Simulink_Model_assignme_B.u3 - /*MW:OvSatOk*/
      Final_Simulink_Model_assignme_B.ATR_PULSE_WIDTH;
    if (Final_Simulink_Model_assignme_B.qY_p >
        Final_Simulink_Model_assignme_B.u3) {
      Final_Simulink_Model_assignme_B.qY_p = 0U;
    }

    Final_Simulink_Model_assignme_B.i3 = (int32_T)
      Final_Simulink_Model_assignme_B.qY_p -
      Final_Simulink_Model_assignme_B.ARP_l;
    if (Final_Simulink_Model_assignme_B.i3 < 0) {
      Final_Simulink_Model_assignme_B.i3 = 0;
    }

    Final_Simulink_Model_assignme_B.out_m = ((uint32_T)((int32_T)
      Final_Simulink_Model_assignm_DW.temporalCounter_i1 * 10) >= (uint32_T)
      Final_Simulink_Model_assignme_B.i3);
  } else {
    Final_Simulink_Model_assignme_B.out_m = false;
  }

  if (Final_Simulink_Model_assignme_B.out_m) {
    Final_Simulink_Model_assignm_DW.is_c7_Final_Simulink_Model_assi =
  ...
  PACE_CHARGE_CTRL, const boolean_T *ATR_CMP_DETECT)
{
  ...
  *PACE_GND_CTRL = true;
  if (!*ATR_CMP_DETECT) {
    Final_Simulink_Model_assignme_B.d2 = rt_roundd_snf(60000.0 / (real_T)
      Final_Simulink_Model_assignme_B.rate);
    if (Final_Simulink_Model_assignme_B.d2 < 256.0) {
      Final_Simulink_Model_assignme_B.u2 = (uint8_T)
        Final_Simulink_Model_assignme_B.d2;
    } else {
      Final_Simulink_Model_assignme_B.u2 = MAX_uint8_T;
    }

    Final_Simulink_Model_assignme_B.qY_b = (uint32_T)
      Final_Simulink_Model_assignme_B.u2 - /*MW:OvSatOk*/
      Final_Simulink_Model_assignme_B.ATR_PULSE_WIDTH;
    if (Final_Simulink_Model_assignme_B.qY_b >
        Final_Simulink_Model_assignme_B.u2) {
      Final_Simulink_Model_assignme_B.qY_b = 0U;
    }

    Final_Simulink_Model_assignme_B.i2 = (int32_T)
      Final_Simulink_Model_assignme_B.qY_b -
      Final_Simulink_Model_assignme_B.ARP_l;
    if (Final_Simulink_Model_assignme_B.i2 < 0) {
      Final_Simulink_Model_assignme_B.i2 = 0;
    }

    Final_Simulink_Model_assignme_B.out_g1 = ((uint32_T)((int32_T)
      Final_Simulink_Model_assignm_DW.temporalCounter_i1 * 10) >= (uint32_T)
      Final_Simulink_Model_assignme_B.i2);
  } else {
    Final_Simulink_Model_assignme_B.out_g1 = false;
  }

  if (Final_Simulink_Model_assignme_B.out_g1) {
    Final_Simulink_Model_assignm_DW.is_c7_Final_Simulink_Model_assi =
  ...
  PACE_CHARGE_CTRL, const boolean_T *VENT_CMP_DETECT)
{
  ...
  *PACE_GND_CTRL = true;
  if (!*VENT_CMP_DETECT) {
    Final_Simulink_Model_assignme_B.d1 = rt_roundd_snf(60000.0 / (real_T)
      Final_Simulink_Model_assignme_B.LRL);
    if (Final_Simulink_Model_assignme_B.d1 < 256.0) {
      Final_Simulink_Model_assignme_B.u1 = (uint8_T)
        Final_Simulink_Model_assignme_B.d1;
    } else {
      Final_Simulink_Model_assignme_B.u1 = MAX_uint8_T;
    }

    Final_Simulink_Model_assignme_B.qY_c = (uint32_T)
      Final_Simulink_Model_assignme_B.u1 - /*MW:OvSatOk*/
      Final_Simulink_Model_assignme_B.VENT_PULSE_WIDTH;
    if (Final_Simulink_Model_assignme_B.qY_c >
        Final_Simulink_Model_assignme_B.u1) {
      Final_Simulink_Model_assignme_B.qY_c = 0U;
    }

    Final_Simulink_Model_assignme_B.i1 = (int32_T)
      Final_Simulink_Model_assignme_B.qY_c -
      Final_Simulink_Model_assignme_B.VRP_o;
    if (Final_Simulink_Model_assignme_B.i1 < 0) {
      Final_Simulink_Model_assignme_B.i1 = 0;
    }

    Final_Simulink_Model_assignme_B.out_g = ((uint32_T)((int32_T)
      Final_Simulink_Model_assignm_DW.temporalCounter_i1 * 10) >= (uint32_T)
      Final_Simulink_Model_assignme_B.i1);
  } else {
    Final_Simulink_Model_assignme_B.out_g = false;
  }

  if (Final_Simulink_Model_assignme_B.out_g) {
    Final_Simulink_Model_assignm_DW.is_c7_Final_Simulink_Model_assi =
  ...
  *PACE_GND_CTRL = true;
  if (!*VENT_CMP_DETECT) {
    ...
    if (Final_Simulink_Model_assignme_B.d < 256.0) {
      Final_Simulink_Model_assignme_B.u = (uint8_T)
        Final_Simulink_Model_assignme_B.d;
    } else {
      Final_Simulink_Model_assignme_B.u = MAX_uint8_T;
    }

    Final_Simulink_Model_assignme_B.qY_k = (uint32_T)
      Final_Simulink_Model_assignme_B.u - /*MW:OvSatOk*/
      Final_Simulink_Model_assignme_B.VENT_PULSE_WIDTH;
    if (Final_Simulink_Model_assignme_B.qY_k > Final_Simulink_Model_assignme_B.u)
    {
    ...
    Final_Simulink_Model_assignme_B.out = ((uint32_T)((int32_T)
      Final_Simulink_Model_assignm_DW.temporalCounter_i1 * 10) >= (uint32_T)
      Final_Simulink_Model_assignme_B.i_m);
  } else {
    Final_Simulink_Model_assignme_B.out = false;
  }

  if (Final_Simulink_Model_assignme_B.out) {
    Final_Simulink_Model_assignm_DW.is_c7_Final_Simulink_Model_assi =
...
static void Final_Simuli_SystemCore_setup_m(freedomk64f_fxos8700_Final_Si_T *obj)
{
  ...
  MW_I2C_MasterWrite(obj->i2cobj.MW_I2C_HANDLE, 29U,
                     ...
                     false, false);
  OSA_TimeDelay(500U);
  Final_Simulink_Model_assignme_B.status_f = 42U;
  Final_Simulink_Model_assignme_B.status_f = MW_I2C_MasterWrite
    (obj->i2cobj.MW_I2C_HANDLE, 29U, &Final_Simulink_Model_assignme_B.status_f,
     1U, true, false);
  if (Final_Simulink_Model_assignme_B.status_f == 0) {
    MW_I2C_MasterRead(obj->i2cobj.MW_I2C_HANDLE, 29U,
                      &Final_Simulink_Model_assignme_B.status_f, 1U, false, true);
    memcpy((void *)&Final_Simulink_Model_assignme_B.b_RegisterValue_c, (void *)
           &Final_Simulink_Model_assignme_B.status_f, (size_t)1 * sizeof(uint8_T));
  } else {
...
void Final_Simulink_Model_assignment_2_step1(void) /* Sample time: [0.01s, 0.0s] */
{
  ...
  Final_Simulink_Model_assignme_B.status = MW_SCI_Receive
    (Final_Simulink_Model_assignm_DW.obj_j.MW_SCIHANDLE,
     &Final_Simulink_Model_assignme_B.RxDataLocChar[0], 37U);
  memcpy((void *)&Final_Simulink_Model_assignme_B.RxData[0], (void *)
         &Final_Simulink_Model_assignme_B.RxDataLocChar[0], (size_t)37 * sizeof
         (uint8_T));
      ...
      if (Final_Simulink_Model_assignme_B.RxData[0] == 22) {
        switch (Final_Simulink_Model_assignme_B.RxData[1]) {
         case 85:
          ...
          memcpy((void *)&Final_Simulink_Model_assignme_B.Reaction_time_d, (void
                  *)&Final_Simulink_Model_assignme_B.RxData[33], (size_t)1 *
                 sizeof(uint16_T));
          memcpy((void *)&Final_Simulink_Model_assignme_B.Recovery_time_d, (void
                  *)&Final_Simulink_Model_assignme_B.RxData[35], (size_t)1 *
                 sizeof(uint16_T));
          break;
...
{
  {
    ...
    Final_Simulink_Model_assignme_B.Recovery_time_d = 300U;
