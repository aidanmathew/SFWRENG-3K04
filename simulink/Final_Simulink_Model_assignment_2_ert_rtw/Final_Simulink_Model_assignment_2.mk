###########################################################################
## Makefile generated for component 'Final_Simulink_Model_assignment_2'. 
## 
## Makefile     : Final_Simulink_Model_assignment_2.mk
## Generated on : Sun Nov 27 00:22:08 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Final_Simulink_Model_assignment_2.elf
...
PRODUCT_NAME              = Final_Simulink_Model_assignment_2
MAKEFILE                  = Final_Simulink_Model_assignment_2.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Hp/DOCUME~1/JIBING~1/McMaster/THRIDY~1/SEMEST~1/3K04/SFWREN~1/simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Final_Simulink_Model_assignment_2_comp.rsp
CMD_FILE                  = Final_Simulink_Model_assignment_2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Final_Simulink_Model_assignment_2.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=37 -DMW_SERIAL0_TXBUF_SIZE=51 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Final_Simulink_Model_assignment_2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o MW_digitalIO.o MW_PWM.o MW_SCI.o MW_AnalogInput.o Final_Simulink_Model_assignment_2.o Final_Simulink_Model_assignment_2_data.o send_params.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Final_Simulink_Model_assignment_2.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/Final_Simulink_Model_assignment_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Final_Simulink_Model_assignment_2_data.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/Final_Simulink_Model_assignment_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_params.o : $(START_DIR)/Final_Simulink_Model_assignment_2_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"
