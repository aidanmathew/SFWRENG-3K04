...
typedef struct {
  ...
  uint16_T Reaction_time_d;            /* '<Root>/COM_IN1' */
  uint16_T Recovery_time_d;            /* '<Root>/COM_IN1' */
  ...
  uint8_T BytePack7[2];                /* '<S8>/Byte Pack7' */
  uint8_T BytePack8[2];                /* '<S8>/Byte Pack8' */
  uint8_T y[2];
  uint8_T b_x[2];
